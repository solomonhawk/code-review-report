...
// export class SlackFormatter extends Effect.Tag("Formatter")<
//   SlackFormatter,
//   FormatterImpl & {
//     formatBlocks: (report: ReportSummary) => Effect.Effect<KnownBlock[]>;
//   }
// >() {
...
//     SlackFormatter.of({
//       format: (report) =>
//         Effect.succeed(JSON.stringify(createSlackBlocks(report), null, 2)).pipe(
//           Effect.withSpan("format slack"),
//         ),
//       formatBlocks: (report) =>
//         Effect.succeed(createSlackBlocks(report)).pipe(
//           Effect.withSpan("formatBlocks slack"),
//         ),
//     }),
//   );
